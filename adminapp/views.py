    ...
    try:
        if request.session['adminid']!=None:
            ...
            if request.method=='POST':
                ...
                myfile=request.FILES['myfile']  # for files
                posteddate=date.today()
                mat=Material(program=program,branch=branch,year=year,subject=subject,materialtype=materialtype,filename=filename,myfile=myfile,posteddate=posteddate).save()
